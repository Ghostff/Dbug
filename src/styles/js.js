...
function heightloop(a) {
    var b = $("#" + a + " table"),
        c = b.height();
    c = "calc(75.7vh - " + c + "px)", c = "height:-moz-" + c + ";height:-webkit-" + c + ";height:-o-" + c + ";height:" + c, b.find(".last-map").attr("style", c)
}
$(document).ready(function() {
    ...
    $(".content-body .loops ." + a).addClass("active");

}), $(".loop-tog").click(function() {
    $(".code-view table .last-map").attr("style", "");
    var a = $(this).attr("data-id");
    $(".code-view, .browser-view").hide(), $("#" + a).show(), heightloop(a);
    var cls = $(this).attr('data-class');
    var type = $(this).attr('data-type');
    var func = $(this).attr('data-function');
    var namespace = $(this).attr('title');
